export const translations = {
  'en-US': {
    ...
    requiredSaving: 'Required Saving',
    daily: 'Daily',
    weekly: 'Weekly',
    monthly: 'Monthly',
    requiredContribution: 'Required to reach goal',
    ...
    multipleExpensesRecorded: 'Bulk expenses recorded successfully!',
  ...
  'fr-FR': {
    ...
    target: 'Cible',
    frequency: 'Fréquence d\'épargne',
    requiredSaving: 'Épargne requise',
    daily: 'Quotidien',
    weekly: 'Hebdomadaire',
    monthly: 'Mensuel',
    requiredContribution: 'Requis pour atteindre l\'objectif',
    ...
    multipleExpensesRecorded: 'Dépenses groupées enregistrées avec succès !',
    ...
    investmentIdeas: 'Stratégie d\'investissement',
    generatingIdeas: 'Génération d\'idées d\'investissement sur mesure...',
    undo: 'Annuler',
    restored: 'Restauré',
